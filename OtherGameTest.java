    ...
    extends JPanel
{
     ...
     */
    public OtherGameTest()
    {

        this.setLayout(null);
        theScore = new JTextPane();

        randomColor = DriverTest.getRandColor();

        diffColor = DriverTest.getDiffColor();
